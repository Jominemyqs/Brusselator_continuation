...
seed_name = sprintf('ic_half_target_%.2f_%.2f.mat', par.sigma, par.b);

% Save final seed in SAME format as ic_0.45_10.mat
ic = ic_end; %#ok<NASGU>

if exist('S','var') && ~isempty(S)
    save(fullfile(outdir, seed_name), 'ic', 'par', 'S', 'V');
    save(fullfile(outdir,'half_target_seed.mat'), 'ic', 'par', 'S', 'V');
else
    save(fullfile(outdir, seed_name), 'ic', 'par', 'V');
    save(fullfile(outdir,'half_target_seed.mat'), 'ic', 'par', 'V');
end
