...
% fixes sigma and searches vertically in b. The threshold remains 8 for
% every target branch; older saved files in this folder mix 8 and 10.
...
contpar.sigma_bounds = [0.28, 0.51741];
...
if run_mid
    ...
    contpar.max_step_arc_length = 0.002;
    contpar.min_step_arc_length = 0.002;
...
outdir = fullfile(output_root, ...
    sprintf('full_continuation_target_task%d_%s', task, tag));
